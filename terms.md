...
일팔공(이하 "앱")은 일본어능력시험(JLPT) 대비 일본어 어휘 학습을 돕기 위해 독립적으로 개발된 iOS 애플리케이션입니다. 앱은 일본어능력시험을 주최하는 국제교류기금 및 일본국제교육지원협회와 무관합니다. 앱은 급수별 학습 콘텐츠를 제공하며, 급수는 N5, N4, N3, N2, N1의 다섯 단계입니다. 각 급수의 단어는 100단어 단위의 책(권)으로 묶여 있고, 급수마다 1권은 무료로, 나머지 권은 앱 내 구매(이용권)를 통해 이용할 수 있습니다.
...
- **유료 범위:** 2권부터 이용하려면 이용권이 필요합니다. 이용권은 **연간 구독**, **월간 구독**, **평생 이용권** 중 하나이며, 어느 것이든 5개 급수의 모든 권이 전부 열립니다. 무료 체험 기간은 제공하지 않습니다.
...
- 일본어능력시험(JLPT)은 국제교류기금과 일본국제교육지원협회가 주최하는 시험입니다. 본 앱은 "시험 대비"라는 서비스의 목적을 설명하기 위한 서술적 용도로만 상표를 언급하며, 국제교류기금·일본국제교육지원협회와 무관하고 두 기관의 제휴나 보증, 승인을 받지 않았습니다.
...
- 문의: [이메일 보내기](mailto:forgelab.aitech@gmail.com?subject=%5BOne80%5D%20%EC%9D%B4%EC%9A%A9%EC%95%BD%EA%B4%80%20%EB%AC%B8%EC%9D%98)
...
One80 ("the App") is an independently developed iOS application that helps users study Japanese vocabulary in preparation for the Japanese-Language Proficiency Test (JLPT). The App is not affiliated with, endorsed or approved by the Japan Foundation or Japan Educational Exchanges and Services. The App provides study content organized by JLPT level, and there are five levels: N5, N4, N3, N2 and N1. Within each level the words are grouped into numbered books of 100 words; the first book of each level is free, and the remaining books can be unlocked through an in-app purchase (a pass).
...
- **Paid tier:** books from the second one onward require a pass: a **yearly subscription**, a **monthly subscription**, or a **lifetime pass**. Each of them unlocks every book across the five levels. No free trial is offered.
...
- The JLPT is administered by the Japan Foundation and Japan Educational Exchanges and Services. The mark is used solely in a descriptive (nominative) manner to indicate the purpose of the App, which is test preparation. This App is not affiliated with, endorsed, or approved by 국제교류기금·일본국제교육지원협회.
...
- Contact: [Send us an email](mailto:forgelab.aitech@gmail.com?subject=%5BOne80%5D%20Terms%20inquiry)
