...
일팔공(이하 "앱")은 일본어능력시험(JLPT) 대비 일본어 어휘 학습을 돕기 위해 독립적으로 개발된 iOS 애플리케이션입니다. 앱은 일본어능력시험을 주최하는 국제교류기금 및 일본국제교육지원협회와 무관합니다. 앱은 레벨(점수대)별 학습 콘텐츠를 제공하며, 레벨은 N5, N4, N3, N2, N1의 다섯 급수. 각 레벨의 단어는 생물학, 천문학, 물리학처럼 학문 주제별 책으로 묶여 있고, 첫 주제 책은 무료로, 나머지 주제 책은 앱 내 구매(이용권)를 통해 이용할 수 있습니다.
